...
FM_PR_FORGE_TIMEOUT=20   # positive seconds allowed for each live GitHub or GitLab lookup while registering a PR; a resolution timeout refuses registration, while an optional GitHub head lookup timeout only omits pr_head
