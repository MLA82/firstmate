...
FM_TEARDOWN_OUTCOME_LOCK_TIMEOUT=10   # positive whole seconds allowed for each ordered status-presentation/outcome-store lock acquire before teardown refuses with durable task records retained; invalid or zero values use 10
